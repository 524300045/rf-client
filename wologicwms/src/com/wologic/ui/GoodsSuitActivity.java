...
public class GoodsSuitActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_goods_suit);
		...
		mediaPlayer = MediaPlayer.create(GoodsSuitActivity.this, R.raw.error);
		mediaPlayerOk = MediaPlayer.create(GoodsSuitActivity.this, R.raw.ok);
		initEvent();
		etCode.requestFocus();
		getGoods("");
	}
	...
	private void initEvent() {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(GoodsSuitActivity.this,
						GoodsSuitCaiJiActivity.class);

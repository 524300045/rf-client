...
public class PartnerOrderActivity extends Activity {
	...
	private String storeCode,outBoundTaskCode;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (intent != null) {
			...
			outBoundTaskCode=intent.getStringExtra("outBoundTaskCode");
		}
		...
		mediaPlayerOk=MediaPlayer.create(
				PartnerOrderActivity.this, R.raw.ok);
			...
			public void run() {
				try {
				  ...
				  String	searchUrl = Constant.url
					...
					outBoundRequest.setOutboundTaskCode(scode);
				...
				try {
					...
					if (jsonSearch.optString("code").toString().equals("200")) 
					{
						if (null == jsonSearch.opt("result")
							...
							else if(boxInfo.getOutboundTaskCode()!=null&&!outBoundTaskCode.equals(boxInfo.getOutboundTaskCode()))
							{
								Message msg = new Message();
								msg.what = 2;
								msg.obj = "当前单据已经其他单据占用"+outBoundTaskCode;
								handler.sendMessage(msg);
							}
							else {
								...
								packageDetailRequest.setOutboundTaskCode(outBoundTaskCode);

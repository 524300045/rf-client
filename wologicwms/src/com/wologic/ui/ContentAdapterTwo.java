...
public class ContentAdapterTwo extends BaseAdapter implements  OnClickListener {

    private static final String TAG = "ContentAdapterTwo";
    ...
    public ContentAdapterTwo(Context context, List<Map<String, Object>> contentList,
            Callback callback) {

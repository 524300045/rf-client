...
public class SortingSuitGoodsStoreActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sortingsuitstore);
		...
		mediaPlayer = MediaPlayer.create(SortingSuitGoodsStoreActivity.this,
				R.raw.error);
		...
		lvgoods.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(SortingSuitGoodsStoreActivity.this,
						SortingSuitPickActivity.class);

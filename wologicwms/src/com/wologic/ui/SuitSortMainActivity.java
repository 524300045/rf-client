...
public class SuitSortMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) 
		...
		setContentView(R.layout.activity_suitsort_main);
	...
	@SuppressLint("NewApi") private void initWave() {
		...
		if (waveList != null && waveList.size() > 0) {
			...
			{
				TableRow tableRow1 = new TableRow(SuitSortMainActivity.this);
				tableRow1.setPadding(5, 10, 5, 5);
				tl.addView(tableRow1);
				
				CheckBox cb=new CheckBox(SuitSortMainActivity.this);

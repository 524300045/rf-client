...
public class StandSortMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) 
		...
		setContentView(R.layout.activity_standsort_main);
		...
		btnAll.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(StandSortMainActivity.this,
	...
	@SuppressLint("NewApi") private void initWave() {
		...
		if (waveList != null && waveList.size() > 0) {
			...
			{
				TableRow tableRow1 = new TableRow(StandSortMainActivity.this);
				tableRow1.setPadding(5, 10, 5, 5);
				tl.addView(tableRow1);
				
				CheckBox cb=new CheckBox(StandSortMainActivity.this);
...
//				Button btn=new Button(StandSortMainActivity.this);

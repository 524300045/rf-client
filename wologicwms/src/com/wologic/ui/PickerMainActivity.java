...
public class PickerMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) 
		...
		btnAll.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(PickerMainActivity.this,
						PickerScanContainerActivity.class);
	...
	@SuppressLint("NewApi") private void initWave() {
		...
		if (waveList != null && waveList.size() > 0) {
			...
			{
				TableRow tableRow1 = new TableRow(PickerMainActivity.this);
				tableRow1.setPadding(5, 10, 5, 5);
				tl.addView(tableRow1);
				//Button btn=new Button(PickerMainActivity.this);
		       // btn.setId(Integer.parseInt(sendWave.getWaveCode()));
				CheckBox cb=new CheckBox(PickerMainActivity.this);

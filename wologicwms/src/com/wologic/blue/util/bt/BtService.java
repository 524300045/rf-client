package com.wologic.blue.util.bt;
...
import com.wologic.blue.util.print.PrintMsgEvent;
import com.wologic.blue.util.print.PrintQueue;
import com.wologic.blue.util.print.PrinterMsgType;
 ...
 * 杩欎釜绫诲畬鎴愭墍鏈夌殑璁剧疆鍜岀鐞嗚摑鐗欑殑宸ヤ綔
 聽 *涓庡叾浠栬澶囩殑杩炴帴銆� 瀹冩湁涓�涓嚎绋嬫潵渚﹀惉鏉ョ數
 聽 *杩炴帴锛岀敤浜庝笌璁惧杩炴帴鐨勭嚎绋嬪拰绾跨▼
 聽 *杩炴帴鏃舵墽琛屾暟鎹紶杈撱��
 */
...
//         Send a failure message back to the Activity
     ...
     * 寮�濮嬭亰澶╂湇鍔°�� 鍏蜂綋鍚姩AcceptThread寮�濮嬩竴涓�
     聽浼氳瘽鍦ㄧ洃鍚紙鏈嶅姟鍣級妯″紡銆� 鐢盇ctivity onResume锛堬級璋冪敤
     */
